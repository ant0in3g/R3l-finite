...
%
\begin{equation}
\mathcal{D} \Phi^j \ \mathcal{D} \Phi^{\dag j} := \prod_{-j\le m,n\le j} \mathcal{D} \Phi^j_{mn} \mathcal{D} \Phi^{\dag j}_{mn} \ , \quad \mbox{and } \ z_j = \frac{8\pi\lambda^3}{3g^2} w(j) \label{measure}
\end{equation}
%
...
%
\begin{equation}
Z_j^{\Omega=\frac13} = N^j \sum_{\sigma_1,\sigma_2\in\mathfrak{S}_{2j+1}} \left|\sigma_1\right| \ \left|\sigma_2\right| \ \prod_{k=-j}^j f_j\left(\omega_{\sigma_1\sigma_2(k)}^j\right) \ , \label{calcul2}
\end{equation}
%
where%
%
\begin{equation}
f_j\left(\omega_{\sigma_1\sigma_2(k)}^j\right) = 
\frac{1}{2} \sqrt{\frac{\pi}{64 z_j}} \ \ \text{Erfc}\left(\frac38 \sqrt{z_j} \ \omega^j_{\sigma_1\sigma_2(k)} \right) \ \mbox{exp}\left(\frac{9}{64} z_j  \left(\omega^{j}_{\sigma_1\sigma_2(k)} \right)^2\right) \ . \label{functionspect}
\end{equation}
%
By using the properties of determinants, \eqref{calcul2} can be written as%
%
\begin{equation}
Z_j^{\Omega=\frac13} = N^j \  \ (2j+1)! \ \ \det_{-j\le m,n\le j} \left(f_j(\omega^j_m+\omega^j_n)\right) \ , \label{partitionfactor}
\end{equation}
%
...
%
\begin{eqnarray}
Z_j^{\Omega=\frac13}(\Sigma^j) &=& N^j(\Sigma^j) \sum_{\pi_1,\pi_2\in\mathfrak{S}_{2j+1}} \left|\pi_1\right| \ \left|\pi_2\right| \prod_{k=-j}^j f_j\left(\omega^j_{\pi_1(k)}+\lambda^j_{\pi_2(k)}\right) \nonumber\\
&=& N^j(\Sigma^j) \ (2j+1)! \ \det_{-j\le m,n\le j}\left(f_j\left(\omega^j_m+\lambda^j_n\right)\right) \ , \label{generat-composit}
\end{eqnarray}
%
...
%
\begin{equation}
Z_j(Q;\Sigma) = \det_{-j\le m,n\le j} \left(\int \frac{dz_1}{i2\pi} \ \frac{dz_2}{i2\pi} \ z_1^{m-1} z_2^{n-1} \ f_j\left(z_1^{-1}+z_2^{-1}\right) \ \exp\left(\sum_{n=1}^\infty t_nz_1^n+ \bar{t}_nz_2^n\right) \right) \ , \label{tau-toda}
\end{equation}
%
in which%
%
...
\begin{eqnarray*}
&& Z_{j=1/2}^{\Omega=\frac13} = N^{\frac12} \ 2! \ \det_{-\frac12\le m,n \le \frac12}\left( f_\frac12\left(\omega_m^{\frac12} + \omega_n^{\frac12}\right)\right) \\[2pt]
&& N^{\frac12} = \left( \Delta\left(Q^\frac12_{\Omega=\frac13}\right) \right)^{-2} \  (1!)^2 \ \left( z_ \frac12 \right)^{-2} \\[2pt]
&& z_ \frac12 = \frac{4\pi\lambda^3}{g^2} \\[2pt]
&& \left(Q^\frac12_{\Omega=\frac13}\right)_{mn} = M + \frac34 \mu \lambda^2 + \frac{8}{3\lambda^{2}} \left(m^2+n^2-mn\right) \\
&& Q^\frac12_{\Omega=\frac13} = 
\left( \begin{array}{ccc}
a + \frac{4}{3\lambda^2} & a \\[5pt]
a & a + \frac{4}{3\lambda^2} \end{array} \right) 
\quad \mbox{with } \ a =  M + \frac34 \mu \lambda^2 + \frac{2}{\lambda^2} \\[2pt]
&& \Delta\left(Q^\frac12_{\Omega=\frac13}\right) = \frac{8}{3\lambda^2} \left(a+\frac29\right) \\[2pt]
&& N^{\frac12} = \frac{729}{256} \frac{g^4}{\pi^2\lambda^2} \\[2pt] 
&& f_\frac12(x) = \frac12 \sqrt{\frac{g^2}{256 \lambda^3}} \ \mbox{Erfc}\left( \frac{3\lambda^{\frac32}}{4g} x \right) \ \mbox{exp}\left( \frac{9\pi\lambda^3}{16g^2} x^2\right) \\[2pt]
&& Q_\mathsf{diag} = 
\left( \begin{array}{ccc}
\frac{4}{3\lambda^2} & 0 \\[5pt]
0 & 2M + \frac32 \mu \lambda^2 + \frac{16}{3\lambda^2} \end{array} \right)
\end{eqnarray*}
